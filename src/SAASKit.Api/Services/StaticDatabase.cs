                ...
                new Team { id = 1, name = "Marketing", avatarImg = "/image/team/marketing.png", Users = new List<User>()
                    {
                        ...
                        new User { id = 2, emailAddress = "james@jones.com", firstName = "James", lastName = "Jones", username = "james.jones", avatarImg = "/image/3.jpg", checkInTime = "2:16PM", checkInLocation = "Boardroom", isMale = true  },
                        new User { id = 3, emailAddress = "sally@brown.com", firstName = "Sally", lastName = "Brown", username = "sally.brown", avatarImg = "/image/2.jpg", checkInTime = "9:45AM", checkInLocation = "Meeting Room #2" },
                        new User { id = 4, emailAddress = "bianca@cole.com", firstName = "Bianca", lastName = "Cole", username = "bianca.cole", avatarImg = "/image/7.jpg",  checkInTime = "10:49PM", checkInLocation = "Cafe"},
                    }
                },
